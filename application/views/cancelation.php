...
<div id="id" class="container-fluid">
    ...
    <hr>
    <h3><b>Pengajuan Pembatalan Transaksi</b></h3>
    <div class="mt-3">
    ...
    <form action="<?php echo site_url('transactions/submit_cancelation') ?>" method="post" class="col-md-6 mt-3 mx-auto">
        <h3>Sertakan alasan pembatalan</h3>
        <input type="text" name="id" value="<?php echo $id ?>" hidden>
        <label class="text-danger" for="alasan">(wajib)</label>
        <input type="text" class="form-control" name="alasan" id="alasan" required>
        <div class="mt-3 text-right">
            <input type="submit" name="submit" class="btn btn-success" value="Ajukan">
        </div>
    </form>
</div>
